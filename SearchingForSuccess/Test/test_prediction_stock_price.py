...
class TestPredictionStockPrice(unittest.TestCase):
    def test_feature_selection_success(self):
        expected_beta = [0, 0, 0.15377572, 0.01381917, 0.02242265, 0.00396967, 0.1834983, 0.01472143, 0.02718057,
                         -0.23020966, 0, 0.00387069, 0.18631227, 0, 0.17873151]
    ...
    def test_feature_selection_Fail(self):
        expected_beta = [1, 0, 0.15377572, 0.01381917, 0.02242265, 0.00396967, 0.1834983, 0.01472143, 0.02718057,
                         -0.23020966, 0, 0.00387069, 0.18631227, 0, 0.17873151]
        test_beta = feature_selection(kw, pr)
    ...
    def test_prediction_model_Success(self):
        ...
        # Transform Stock Price to Price Change. 1 for positive change 0 for not positive change.
